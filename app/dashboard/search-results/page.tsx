import { fetchFilteredEletronics, fetchFakeElectronics } from "@/app/lib/data";
...
export default async function SearchResults({
  ...
  const fakeElectronics = await fetchFakeElectronics();
        ...
        <>
          ...
          <div className="max-w-[900px] w-full px-2 sm:m-auto pt-2">
            ...
            <div className="flex flex-wrap justify-center items-center gap-2 sm:gap-4 pt-6">
              <ProductsBox electronicProducts={fakeElectronics} />
            </div>
          </div>
        </>
      ) : (
